...
const home = () => {
    ...
    const fetch = async () => {
        ...
        const headlinesurl = 'https://gnews.io/api/v4/top-headlines?lang=en&country=in&max=100&apikey=' + apikey;
    ...
    return (
        topHeadLines && <>
            ...
            <div id='horiZontalSlide' className="horiZontalSlide w-full flex justify-center my-10">
                ...
                <div className=' h-full flex justify-between p-2'>
                    {[1,2,3,4,5,6,7,8].map((_ , i)=>{
                        ...
                        <div className="headline h-2/5 overflow-auto text-sm font-[500] font-serif p-1">{topHeadLines[i].title}</div>
                        <div className=" absolute bottom-0 readmoreBtn mb-2 px-1">
                            <Link to={topHeadLines[i].url}> <button className='btn bg-red-600 rounded-md hover:bg-red-700 text-sm text-white'>
                                Read More
                            </button>
                            </Link>
                        </div>
                ...
                <div className=' flex justify-center items-center'>
                    <div className="leftPart w-7/12 bg-stone-200 py-6">
                        <div className="topHeadLine">
                            ...
                            <div className="headline text-3xl text-center font-[500] mx-auto font-serif text-black w-10/12 ">{topHeadLines[0].title}</div>
                        </div>
                            ...
                            {topHeadLines.map((_, i) => {
                                if (i !== 0) {
                                    return <div className=' my-4 bg-stone-100 p-2 w-full'>
                                        <div className="img">
                                            <img className=' w-full' src={topHeadLines[i].image} />
                                        </div>
                                        <div className="headline text-base font-[600] font-serif">{topHeadLines[i].title}</div>
                                        <div className="content text-sm">{topHeadLines[i].description}</div>
                                        <div className="readmoreBtn my-6 mb-3">
                                            <Link to={topHeadLines[i].url}> <button className='btn bg-red-600 rounded-md hover:bg-red-700 text-lg text-white'>
                                                Read More
                                            </button>
                                            </Link>
                                        </div>
            ...
            <div id="part3" className=' mb-10' >
                <div className="link py-4 mx-12 border-t-2 border-slate-900 " style={{ letterSpacing: "1px" }}><span className='text-xl flex hover:mx-14 transition-all duration-500 cursor-pointer mx-12'>topHeadLines<svg className=' mx-2' style={{ width: "25px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" /></svg></span> </div>
                <div className=' flex justify-center items-center'>
                    <div className="rightPart w-3/12  p-3 overflow-auto">
                        <div className="verticalSlide">
                            {topHeadLines.map((_, i) => {
